...
class ProductControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'product[price_net]' => 'Something New',
            'product[tax]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getPrice_net());
